...
# Show the plot
plt.savefig('../figures/ChangeEXP_Top5.png')

display(Image(filename="../figures/ChangeEXP_Top5.png"))
```
...
# Show the plot
plt.savefig('../figures/GDPPerCapNom_Top5.png')
display(Image(filename="../figures/GDPPerCapNom_Top5.png"))
```
...
# Show the plot
plt.savefig('../figures/EmployRatio_Top5.png')
display(Image(filename="../figures/EmployRatio_Top5.png"))
```
