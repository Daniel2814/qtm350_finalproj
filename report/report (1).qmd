...
data_EXP = pd.read_csv(
    "../data/API_NE.EXP.GNFS.ZS_DS2_en_csv_v2_19646/API_NE.EXP.GNFS.ZS_DS2_en_csv_v2_19646.csv"
)
...
display(Image(filename="../figures/ChangeEXP(Top5).png"))
```
...
display(Image(filename="../figures/GDPPerCapNom(Top5).png"))
```
...
display(Image(filename="../figures/EmployRatio(Top5).png"))
```
