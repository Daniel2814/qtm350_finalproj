...
Here are the results from the Employment to population analysis.
...
This chart shows how employment-to-population ratios have evolved across global regions from 1990 to 2024. North America and East Asia & Pacific consistently maintain the highest employment rates, while the Middle East & North Africa region remains persistently lower. A sharp decline around 2020 is visible across all regions, reflecting the impact of the COVID-19 pandemic, though most regions show signs of partial recovery afterward. Overall, the world average exhibits a slow, steady decline over time, highlighting long-term global shifts in labor market participation.
